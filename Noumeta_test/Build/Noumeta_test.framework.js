...
var ASM_CONSTS = {
  3391804: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3391859: function($0) {performance.now = function() { return $0; };},  
 3391907: function($0) {performance.now = function() { return $0; };},  
 3391955: function() {performance.now = Module['emscripten_get_now_backup'];},  
 3392010: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3392071: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3392135: function() {return Module.webglContextAttributes.powerPreference;}
};
      ...
      el.onchange = function () {
        if (window.unityInstance) {
          window.unityInstance.SendMessage(
            "avatar_input",    // Unity上のGameObject名
            "OnInputComplete", // 呼び出したい関数
            el.value           // 渡す値
          );
        }
      };
