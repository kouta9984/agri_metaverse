...
var ASM_CONSTS = {
  3391180: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3391235: function($0) {performance.now = function() { return $0; };},  
 3391283: function($0) {performance.now = function() { return $0; };},  
 3391331: function() {performance.now = Module['emscripten_get_now_backup'];},  
 3391386: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3391447: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3391511: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _JoinChannel(tokenPtr, channelNamePtr, uid) {
      ...
      // ✅ 空文字や "null" 文字列も null として扱う
      var token = (!tokenStr || tokenStr === "null") ? null : tokenStr;
