...
var ASM_CONSTS = {
  3391260: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3391315: function($0) {performance.now = function() { return $0; };},  
 3391363: function($0) {performance.now = function() { return $0; };},  
 3391411: function() {performance.now = Module['emscripten_get_now_backup'];},  
 3391466: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3391527: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3391591: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _JoinChannel(tokenPtr, channelNamePtr, uid) {
      ...
      // tokenPtr が null/0 の場合に UTF8ToString を呼ばない
      var tokenStr = tokenPtr ? UTF8ToString(tokenPtr) : null;
  
      // 空文字や "null" を除外して null 扱いにする
      var token = (tokenStr && tokenStr !== "null" && tokenStr !== "") ? tokenStr : null;
  
      var channel = UTF8ToString(channelNamePtr);
      console.log("Attempting to join channel:", channel, "with token:", token, "UID:", uid);
  ...
  async function _ThirdwebSwitchNetwork(chainId) {
  ...
  function _initWebRTC(roomPtr) {
      const roomId = UTF8ToString(roomPtr);
      // ここで実際にJSでやりたい処理を呼ぶ
      initWebRTC(roomId);
    }
